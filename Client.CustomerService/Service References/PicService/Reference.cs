...
// 
namespace Client.CustomerService.PicService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Client.CustomerService.PicService.OperatingResultOfstring))]
    ...
    public partial class OperatingResultOfstring : Client.CustomerService.PicService.OperatingResult {
    ...
    public interface IPicService {
        ...
        Client.CustomerService.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPicServiceChannel : Client.CustomerService.PicService.IPicService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class UploadCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Client.CustomerService.PicService.OperatingResultOfstring Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Client.CustomerService.PicService.OperatingResultOfstring)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PicServiceClient : System.ServiceModel.ClientBase<Client.CustomerService.PicService.IPicService>, Client.CustomerService.PicService.IPicService {
        ...
        System.IAsyncResult Client.CustomerService.PicService.IPicService.BeginUpload(byte[] picStream, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUpload(picStream, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Client.CustomerService.PicService.OperatingResultOfstring Client.CustomerService.PicService.IPicService.EndUpload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUpload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Client.CustomerService.PicService.IPicService)(this)).BeginUpload(picStream, callback, asyncState);
        }
        
        private object[] OnEndUpload(System.IAsyncResult result) {
            Client.CustomerService.PicService.OperatingResultOfstring retVal = ((Client.CustomerService.PicService.IPicService)(this)).EndUpload(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Client.CustomerService.PicService.IPicService.BeginDownload(string token, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDownload(token, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] Client.CustomerService.PicService.IPicService.EndDownload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDownload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Client.CustomerService.PicService.IPicService)(this)).BeginDownload(token, callback, asyncState);
        }
        
        private object[] OnEndDownload(System.IAsyncResult result) {
            byte[] retVal = ((Client.CustomerService.PicService.IPicService)(this)).EndDownload(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override Client.CustomerService.PicService.IPicService CreateChannel() {
            return new PicServiceClientChannel(this);
        }
        
        private class PicServiceClientChannel : ChannelBase<Client.CustomerService.PicService.IPicService>, Client.CustomerService.PicService.IPicService {
            
            public PicServiceClientChannel(System.ServiceModel.ClientBase<Client.CustomerService.PicService.IPicService> client) : 
                    base(client) {
            }
            ...
            public Client.CustomerService.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result) {
                object[] _args = new object[0];
                Client.CustomerService.PicService.OperatingResultOfstring _result = ((Client.CustomerService.PicService.OperatingResultOfstring)(base.EndInvoke("Upload", _args, result)));
                return _result;
            }
