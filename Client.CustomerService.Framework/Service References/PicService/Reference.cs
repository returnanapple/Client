...
// 
namespace Client.CustomerService.Framework.PicService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Client.CustomerService.Framework.PicService.OperatingResultOfstring))]
    ...
    public partial class OperatingResultOfstring : Client.CustomerService.Framework.PicService.OperatingResult {
    ...
    public interface IPicService {
        ...
        Client.CustomerService.Framework.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPicServiceChannel : Client.CustomerService.Framework.PicService.IPicService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class UploadCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Client.CustomerService.Framework.PicService.OperatingResultOfstring Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Client.CustomerService.Framework.PicService.OperatingResultOfstring)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PicServiceClient : System.ServiceModel.ClientBase<Client.CustomerService.Framework.PicService.IPicService>, Client.CustomerService.Framework.PicService.IPicService {
        ...
        System.IAsyncResult Client.CustomerService.Framework.PicService.IPicService.BeginUpload(byte[] picStream, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUpload(picStream, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Client.CustomerService.Framework.PicService.OperatingResultOfstring Client.CustomerService.Framework.PicService.IPicService.EndUpload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUpload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Client.CustomerService.Framework.PicService.IPicService)(this)).BeginUpload(picStream, callback, asyncState);
        }
        
        private object[] OnEndUpload(System.IAsyncResult result) {
            Client.CustomerService.Framework.PicService.OperatingResultOfstring retVal = ((Client.CustomerService.Framework.PicService.IPicService)(this)).EndUpload(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Client.CustomerService.Framework.PicService.IPicService.BeginDownload(string token, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDownload(token, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] Client.CustomerService.Framework.PicService.IPicService.EndDownload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDownload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Client.CustomerService.Framework.PicService.IPicService)(this)).BeginDownload(token, callback, asyncState);
        }
        
        private object[] OnEndDownload(System.IAsyncResult result) {
            byte[] retVal = ((Client.CustomerService.Framework.PicService.IPicService)(this)).EndDownload(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override Client.CustomerService.Framework.PicService.IPicService CreateChannel() {
            return new PicServiceClientChannel(this);
        }
        
        private class PicServiceClientChannel : ChannelBase<Client.CustomerService.Framework.PicService.IPicService>, Client.CustomerService.Framework.PicService.IPicService {
            
            public PicServiceClientChannel(System.ServiceModel.ClientBase<Client.CustomerService.Framework.PicService.IPicService> client) : 
                    base(client) {
            }
            ...
            public Client.CustomerService.Framework.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result) {
                object[] _args = new object[0];
                Client.CustomerService.Framework.PicService.OperatingResultOfstring _result = ((Client.CustomerService.Framework.PicService.OperatingResultOfstring)(base.EndInvoke("Upload", _args, result)));
                return _result;
            }
