...
namespace ToClient.PicService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(ToClient.PicService.OperatingResultOfstring))]
    ...
    public partial class OperatingResultOfstring : ToClient.PicService.OperatingResult {
    ...
    public interface IPicService {
        ...
        ToClient.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPicServiceChannel : ToClient.PicService.IPicService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class UploadCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public ToClient.PicService.OperatingResultOfstring Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((ToClient.PicService.OperatingResultOfstring)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PicServiceClient : System.ServiceModel.ClientBase<ToClient.PicService.IPicService>, ToClient.PicService.IPicService {
        ...
        System.IAsyncResult ToClient.PicService.IPicService.BeginUpload(byte[] picStream, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUpload(picStream, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ToClient.PicService.OperatingResultOfstring ToClient.PicService.IPicService.EndUpload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUpload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((ToClient.PicService.IPicService)(this)).BeginUpload(picStream, callback, asyncState);
        }
        
        private object[] OnEndUpload(System.IAsyncResult result) {
            ToClient.PicService.OperatingResultOfstring retVal = ((ToClient.PicService.IPicService)(this)).EndUpload(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult ToClient.PicService.IPicService.BeginDownload(string token, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDownload(token, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] ToClient.PicService.IPicService.EndDownload(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDownload(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((ToClient.PicService.IPicService)(this)).BeginDownload(token, callback, asyncState);
        }
        
        private object[] OnEndDownload(System.IAsyncResult result) {
            byte[] retVal = ((ToClient.PicService.IPicService)(this)).EndDownload(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override ToClient.PicService.IPicService CreateChannel() {
            return new PicServiceClientChannel(this);
        }
        
        private class PicServiceClientChannel : ChannelBase<ToClient.PicService.IPicService>, ToClient.PicService.IPicService {
            
            public PicServiceClientChannel(System.ServiceModel.ClientBase<ToClient.PicService.IPicService> client) : 
                    base(client) {
            }
            ...
            public ToClient.PicService.OperatingResultOfstring EndUpload(System.IAsyncResult result) {
                object[] _args = new object[0];
                ToClient.PicService.OperatingResultOfstring _result = ((ToClient.PicService.OperatingResultOfstring)(base.EndInvoke("Upload", _args, result)));
                return _result;
            }
